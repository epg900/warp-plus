...
install() {
    ...
    if wget https://github.com/epg900/warp-plus/releases/download/warp/warp-plus_android-arm64.zip &&
...
install_arm() {
    ...
    WARP_URL="https://github.com/epg900/warp-plus/releases/download/warp/warp-plus_linux-$ARCH.zip"
